      ...
      <div className="px-xl py-xxxl border-t border-gray-4">
        <div className="flex flex-col items-center justify-center text-center">
          <div className="w-24 h-24 bg-brand-light rounded-full flex items-center justify-center mb-lg">
            <Users className="w-12 h-12 text-brand opacity-60" />
          </div>
          <h2 className="text-section-title font-semibold text-gray-8 mb-sm">职工之家</h2>
...
export default PartyWorkersEditor;
